...
class Conservacion_estados_model extends CI_Model {
    ...
    public function select($modo, $select = array(), $condicion = array(), $order = '') {
        ...
        $sql = "SELECT " . $campos . " FROM CONSERVACION_ESTADOS WHERE 1 = 1 " . $where . " " . $order;
